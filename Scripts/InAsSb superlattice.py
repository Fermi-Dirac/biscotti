...
InAsPurefile = bulkpeices +os.path.sep + r'InAs_Best_Cubic.in'
InAsSbPurefile = bulkpeices + os.path.sep + r'InAsSb_Best_Cubic_Strained.in'

newbatch = r'Batch006 - Small, Ideal SL'
